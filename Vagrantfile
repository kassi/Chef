...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ksi-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/kluks"
  #   chef.validation_client_name = "kluks-validator"
  #   chef.validation_key_path = ".chef/kluks-validator.pem"
  # end
end
